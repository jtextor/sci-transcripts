...
There is a nice Python package that helps with optimizing maximum-likelihood and least-squares fits, it is called [iminuit](https://scikit-hep.org/iminuit/ "iminuit"). I used this during another course and I thought it would be worth sharing here, as it provides a straightforward way to fit models by simply defining your own fit or likelihood function in Python.
